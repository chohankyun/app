...
from backend.api.join.views import Login, IsAuth, Logout, RegisterView, EmailConfirmView, AppIdFindView, PasswordResetView, PasswordResetConfirmView, PasswordChangeView
